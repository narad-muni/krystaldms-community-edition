...
setTimeout(function(){
	if(getCookie("darkMode")=="TRUE"){
    	$("#colorbox").addClass("darkMode");
    	$("html").addClass("darkMode");
    	$("iframe").addClass("darkMode");
    	$("img").addClass("darkMode");
    	$("#darkMode").attr("checked","");
    	$("#lightMode").removeAttr("checked");
    }else{
    	$("#colorbox").removeClass("darkMode");
    	$("html").removeClass("darkMode");
    	$("iframe").removeClass("darkMode");
    	$("img").removeClass("darkMode");
...
$(document).ready(function(){
    $("#changePasswordModal").on("show.bs.modal", function(event){
        $(this).find(".modal-content").load($(event.relatedTarget).attr("href"));
    });
    if(getCookie("darkMode")=="TRUE"){
    	$("#colorbox").addClass("darkMode");
    	$("html").addClass("darkMode");
    	...
    	$("iframe").removeClass("darkMode");
    	$("img").removeClass("darkMode");
    	$("#lightMode").attr("checked","checked");
    	$("#darkMode").removeAttr("checked");
    }
});

$(document).ready(function(){
    $("#revisionHistoryModal").on("show.bs.modal", function(event){
        $(this).find(".modal-content").load($(event.relatedTarget).attr("href"));
    });
});
