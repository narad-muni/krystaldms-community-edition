...
public class ViewDocumentView extends WebView {
	...
	private void printDocument() throws Exception{
		...
		out.println("<span class=\"badge bg-success tip\" data-bs-toggle=\"tooltip\" data-bs-placement=\"bottom\" title=\"File Size\">"+StringHelper.formatSizeText(documentRevision.getLength())+"</span></small></h3>");
		...
		try {
			...
			out.println("<div class=\"card card-body pr-2 pr-2\" id=\"viewer\">");
			out.println("<iframe class=\"darkMode\" src = \"/js/ViewerJS/?file=/console/mobiledocumentviewer%3Fdocumentid%3D"+documentRevision.getDocumentId()+"%26revisionid%3D"+documentRevision.getRevisionId()+"\" width='100%' height='800'></iframe>");
			...
			if(acl.canEmail()){
				...
				out.println("<span><input type=\"text\" id=\"txtEmail\" name=\"txtEmail\" class=\"required form-control multiemail\" maxlength=\"500\" title=\"Please use a comma to separate multiple email addresses\"/></span>");
				out.println("</div>");
			...
			if(acl.canWrite() && document.getStatus().equalsIgnoreCase(Hit.STATUS_AVAILABLE) && isHeadRevision){
				...
				out.println("<div class=\"card-body\">");
				out.println("<form autocomplete=\"off\" action=\"/console/editdocumentindexes\" method=\"post\" id=\"frmEditIndexes\" accept-charset=\"utf-8\"  form-type=\"ajax\" datatarget=\"#resultIndexes\">");
...
//			}
			...
			out.println("<div class=\"col-sm-3\">");
			out.println("<div class=\"card   \">");
			out.println("<div class=\"card-header\"><i class=\"bi bi-chat-dots \"></i> Add Note / Comments</div>");
			out.println("<div class=\"card-body\">");
			...
			out.println("<div class=\"card-body\">");
			out.println("<form autocomplete=\"off\" action=\"/console/accesshistory\" id=\"frmAccessHistory\" method=\"post\" form-type=\"ajax\" datatarget=\"#resultAccessHistory\">");
			out.println("<div class=\"mb-3 row\">");
