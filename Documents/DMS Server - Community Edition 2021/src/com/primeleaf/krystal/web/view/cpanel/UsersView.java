		...
		try {
			...
			if(userList.size() > 0 ){
				...
				for (User user:userList) {
					...
					if(user.isLoggedIn()){
						out.println("<i class=\"bi bi-check text-success\"></i> ");
					}
					out.println("</h4>");
					...
					out.println(" | <a href=\""+HTTPConstants.BASEURL+"/cpanel/changeuserpassword?userid="+user.getUserId()+"\"  title=\"Change Password\" data-bs-toggle=\"modal\" data-bs-target=\"#changePasswordModal\">Change Password</a>");
