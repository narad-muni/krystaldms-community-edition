...
public class ForgotPasswordView extends WebView{
	...
	private void printResetPassword() throws Exception{
		...
		out.print("                   <p class=\"display-5 mb-4\"><i class=\"bi bi-box-arrow-in-right me-2\"></i>Resert Password</p>");
		...
		out.print("                   <div class=\"d-grid gap-2\">    <button type=\"submit\" class=\"btn btn-danger\" data-loading-text=\"Please wait...\" id=\"btnLogin\"><i class=\"bi bi-arrow-counterclockwise h6 me-2\"></i>Reset</button>    </div>");
		out.print("                   <p class=\"text-center m-4\"><a href=\"/login\">Login ?</a></p>");
		out.print("                </div>");
		out.print("             </div>");
		out.print("          </div>");
		out.print("       </div>");
