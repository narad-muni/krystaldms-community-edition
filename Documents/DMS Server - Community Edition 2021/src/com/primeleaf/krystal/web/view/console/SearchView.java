...
public class SearchView extends WebView {
	...
	private void printSearchResults() throws Exception{
		...
		out.println("<div class=\"card card-body pr-2 pr-2 row g-2\">");
	...
	private void printDocumentClasses(){
		...
		if(documentClassList.size() > 0 ){
			...
			out.println("<h4><i class=\"bi bi-folder2-open \"></i> Document Classes</h4>");
			out.println("</div>");
	...
	private void printDocumentNotes(){
		...
		if(documentNotes.size() > 0 ) {
			...
			out.println("<div class=\"row\">");
			out.println("<div class=\"col-xs-8\">");
			out.println("<h4><i class=\"bi bi-chat-dots\"></i> Document Notes</h4>");
			out.println("</div>");
			out.println("<div class=\"col-xs-4 text-end\">");
