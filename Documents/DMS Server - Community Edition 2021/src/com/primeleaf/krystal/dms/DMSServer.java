...
//		try {
//			File ConfigFile = new File(KRYSTAL_HOME+"/configuration/server.config");
//			Scanner myReader = new Scanner(ConfigFile);
//			 while (myReader.hasNextLine()) {
//			        String data = myReader.nextLine();
//			       if(data.startsWith("HTTP_PORT=")) {
//			    	   int httpPort=Integer.valueOf(data.substring(10));
//			       }else if(data.startsWith("SMTP_PORT=")){
//			    	   
//			       }else if(data.startsWith("SMTP_USERNAME=")){
//			    	   
//			       }else if(data.startsWith("SMTP_PASSWORD=")){
//			    	   
//			       }else if(data.startsWith("SMTP_HOST=")){
//			    	   
//			       }
//			      }
//			 myReader.close();
...
//	}
	...
	private void startWebApplications() {
		try{
			...
			int httpPort=ConfigParser.getPort();
